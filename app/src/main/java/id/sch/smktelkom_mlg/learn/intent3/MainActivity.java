...
public class MainActivity extends AppCompatActivity {
    static final int REQUEST_IMAGE_CAPTUTRE = 1;
    ...
    public void capturePhoto() {
        ...
        if (intent.resolveActivity(getPackageManager()) != null)
            startActivityForResult(intent, REQUEST_IMAGE_CAPTUTRE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTUTRE && resultCode == RESULT_OK) {
            ...
            ImageView iv = (ImageView) findViewById(R.id.imageViewViewCamera);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.imageViewViewCamera)
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        capturePhoto();
